...
@Autonomous(name = "Red_Right_Corner", group = "main")
public class Red_Right_Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(tip_autonomie==0)
        {
            roadRunner.init(119, 77, 0, true, Geometry.pi / 2, 1);
        ...
        {
            roadRunner.init(119, 67, 0, true, Geometry.pi / 2, 1);
        ...
        {
            roadRunner.init(118, 55, 0, true, Geometry.pi / 2, 1);
        ...
        roadRunner.init(80, 10, 0, true, Geometry.pi / 2, 1);
        ...
        roadRunner.init(122, 10, 0, true, Geometry.pi / 2, 1);
