...
@Disabled
@Autonomous(name = "zred_left_mijloc_wait", group = "main")
public class red_left_mijloc_wait extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        roadRunner.init(0, 61, 0, true, 0, 1);

        while (roadRunner.isRunning)
            roadRunner.run();

        roadRunner.init(195, 61, 0, true, 0, 1);
        ...
        roadRunner.init(231.5, 65, 0, true, Geometry.pi / 2, 1);
        ...
        roadRunner.init(231.5, 115, 0, true, Geometry.pi / 2, 1);
