...
@Autonomous(name = "zblue_right_mijloc_wait", group = "main")
public class blue_right_mijloc_wait extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        roadRunner.init(-224.75, 115, 0, true, -Geometry.pi / 2, 1);
