...
@Autonomous(name = "zBlue_Left_Corner", group = "main")
public class Blue_Left_Corner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(tip_autonomie==0)
        {
            roadRunner.init(-110, 56, 0, true, -Geometry.pi / 1.90, 1);
        }
        else if(tip_autonomie==1)
        {
            roadRunner.init(-106, 78, 0, true, -Geometry.pi / 2, 1);
        }
        else if(tip_autonomie==2)
        {
            roadRunner.init(-108, 98, 0, true, -Geometry.pi / 2, 1);
        }
        ...
        roadRunner.init(-85, 18, 0, true, -Geometry.pi / 2, 1);
        ...
        roadRunner.init(-115, 18, 0, true, -Geometry.pi / 2, 1);
